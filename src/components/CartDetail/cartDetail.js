                                ...
                                <tbody>
                                    <tr>
                                        <td className="cart_product_img d-flex align-items-center">
                                            <a ><img src="img/product-img/p1a.jpg" alt="Product"/></a>
                                            <h6>{this.state.data[0].namaProduct}</h6>
                                        </td>
                                        <td className="price"><span>{this.state.data[0].harga}</span></td>
                                        <td className="qty">
                                        ...
                                        <td className="total_price"><span></span></td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
